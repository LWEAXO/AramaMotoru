...
1) Projeyi İndirin Ve Masaüstüne Atın.

2) Dosyaya [Sağ click] Basınız Ve [Birlikte Aç] ile kullanacağınız Tarayıcıyı Seçiniz.
...
1) [Exe, Pdf, Doc, txt, Png, Jpg, Zip, Mp3, Mp4] Arama Seçenekleri vardır.

2) [Yandex, Google, DuckDuckgo, Ecosia] Arama Motorlarına Sahiptir.
